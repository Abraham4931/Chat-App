...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`input input-bordered w-full pl-10 [&::-ms-reveal]:hidden [&::-ms-clear]:hidden`}
                  placeholder="........"
      ...
      <AuthImagePattern
        title="Welcome back!"
        subtitle="Sign in to continue your conversations and catch up with your contacts."
      />
    </div>
  );
};
